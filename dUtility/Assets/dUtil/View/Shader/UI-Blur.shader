    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag (v2f i) : SV_Target
            {
                ...
                #define ATPIXEL(offsetX, offsetY) tex2Dproj(_GrabTexture, UNITY_PROJ_COORD(float4(i.uv.x + _GrabTexture_TexelSize.x * offsetX, i.uv.y + _GrabTexture_TexelSize.y * offsetY, i.uv.z, i.uv.w)))
                ...
                float2 src = (i.uv - CENTER) / 10 + CENTER;
                return ATPIXEL(src.x, src.y);
                // pixelCol = ADDPIXEL(1.0, 5.0);
                // return pixelCol;
                // return circle(i.uv, 0.5, CENTER) * pixelCol;
            }
            ENDCG
        }
